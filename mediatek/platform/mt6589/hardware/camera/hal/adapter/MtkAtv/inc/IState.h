#ifndef _MTK_HAL_CAMADAPTER_MTKATV_INC_ISTATE_H_
#define _MTK_HAL_CAMADAPTER_MTKATV_INC_ISTATE_H_
//
...
#endif // _MTK_HAL_CAMADAPTER_MTKATV_INC_ISTATE_H_

#ifndef _MTK_HAL_CAMADAPTER_MTKATV_STATE_STATE_H_
#define _MTK_HAL_CAMADAPTER_MTKATV_STATE_STATE_H_
//
...
*/
struct StateCapturePreview : public StateBase
{
...
#endif // _MTK_HAL_CAMADAPTER_MTKATV_STATE_STATE_H_

#ifndef _MTK_HAL_CAMADAPTER_MTKVT_INC_CAPTURECMDQUETHREAD_H_
#define _MTK_HAL_CAMADAPTER_MTKVT_INC_CAPTURECMDQUETHREAD_H_
//
...
#endif  //_MTK_HAL_CAMADAPTER_MTKVT_INC_CAPTURECMDQUETHREAD_H_

...
#define ACDK_LOGD(fmt,...)  VV_MSG("[%s]"fmt"\n", __FUNCTION__, ##__VA_ARGS__)
#define ACDK_INFO(fmt,...)  VV_MSG("[%s]Info(%5d):"fmt"\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
#define ACDK_WARN(fmt,...)  VV_MSG("[%s]Warning(%5d):"fmt"\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
#define ACDK_LOGE(fmt,...)  VV_ERRMSG("[%s]Err(%5d):"fmt"\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
...
#define ACDK_INFO(fmt,arg...)      XLOGI("[%s]WRN(%5d):" fmt, __func__, __LINE__, ##arg)
#define ACDK_WARN(fmt,arg...)      XLOGW(fmt, ##arg)
#define ACDK_LOGE(fmt,arg...)      XLOGE("{#%d:%s}Err : " fmt,__LINE__,__FILE__, ##arg)

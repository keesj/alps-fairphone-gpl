...
IMP_CCT_CTRL( ACDK_CCT_OP_3A_LOAD_FROM_NVRAM ) //implement by Yosen
{
    MINT32 err = CCTIF_NO_ERROR;
...
IMP_CCT_CTRL( ACDK_CCT_V2_OP_ISP_SET_SHADING_ON_OFF )
{
    ...
    pShadingPara->Enable = MTRUE;   ////Yulia added, to work around double buffer
    ...
    switch (pCAMERA_NVRAM_DATA->Mode)
    {
        ...
        case CAMERA_NVRAM_SHADING_STRUCT:
        {
            ...
            *pu4RealParaOutLen = sizeof(ISP_SHADING_STRUCT);
            ...
            break;
        case CAMERA_NVRAM_3A_STRUCT: //implement by Yosen
        {
//			MINT32 err = CCTIF_NO_ERROR;
//    		err = m_rBufIf_3A.refresh(m_eSensorEnum, m_u4SensorID); //Yosen
//    		if  ( CCTIF_NO_ERROR != err )
//    		{
...
//    		}				
        ...
        case CAMERA_NVRAM_ISP_PARAM_STRUCT:
        {
            ...
            *pu4RealParaOutLen = sizeof(NVRAM_CAMERA_ISP_PARAM_STRUCT);
            ...
            break;
		case CAMERA_NVRAM_LENS_STRUCT: //implement by Yosen
        {
//			MINT32 err = CCTIF_NO_ERROR;
//    		err = m_rBufIf_LN.refresh(m_eSensorEnum, m_u4SensorID); //Yosen
//    		if  ( CCTIF_NO_ERROR != err )
//    		{

...
typedef struct {
	...
	NSNvram::BufIF<NVRAM_CAMERA_3A_STRUCT>*	pbufIf_3a; //Yosen
	NSNvram::BufIF<NVRAM_LENS_PARA_STRUCT>*	pbufIf_ln; //Yosen
...
private:    ////    NVRAM buffer I/F.
    ...
    NSNvram::BufIF<NVRAM_CAMERA_3A_STRUCT>&    m_rBufIf_3A; //3A, Yosen
    NSNvram::BufIF<NVRAM_LENS_PARA_STRUCT>&    m_rBufIf_LN; //Len, Yosen
...
private:	////	NVRAM buffer.
	...
	NVRAM_CAMERA_3A_STRUCT&	m_rBuf_3A; //Yosen
...
private:	////	NVRAM buffer.
	...
	NVRAM_LENS_PARA_STRUCT&	m_rBuf_LN; //Yosen

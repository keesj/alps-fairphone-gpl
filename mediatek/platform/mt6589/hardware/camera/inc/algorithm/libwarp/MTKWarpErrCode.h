...
#define MTK_WARP_OKCODE(errid)         OKCODE(MODULE_MTK_WARP, errid)
#define MTK_WARP_ERRCODE(errid)        ERRCODE(MODULE_MTK_WARP, errid)


// Detection error code
#define S_WARP_OK                  MTK_WARP_OKCODE(0x0000)

#define E_WARP_NEED_OVER_WRITE     MTK_WARP_ERRCODE(0x0001)
#define E_WARP_NULL_OBJECT         MTK_WARP_ERRCODE(0x0002)
#define E_WARP_WRONG_STATE         MTK_WARP_ERRCODE(0x0003)
#define E_WARP_WRONG_CMD_ID        MTK_WARP_ERRCODE(0x0004)
#define E_WARP_WRONG_CMD_PARAM     MTK_WARP_ERRCODE(0x0005)
#define E_WARP_INSUFF_WORK_BUF     MTK_WARP_ERRCODE(0x0006)
#define E_WARP_EGL_CONFIG          MTK_WARP_ERRCODE(0x0006)

#define E_WARP_ERR                 MTK_WARP_ERRCODE(0x0100)

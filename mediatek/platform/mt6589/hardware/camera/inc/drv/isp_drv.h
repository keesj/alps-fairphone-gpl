...
//TH    CAM_TOP_IMGSYS  = 0, // 99   15000000~15000188
    ...
    CAM_DMA_P2_IMG2O,    // 8    15004320~1500433C  //for pass2
    ...
    CAM_ISP_AE,          // 13   15004650~15004680
    CAM_ISP_SGG,         // 2    150046A0~150046A4
    CAM_ISP_AF,          // 17   150046B0~150046F0
...
class IspDrv
{
    ...
    public:
        ...
        static IspDrv*  createInstance(bool fgIsGdmaMode = MFALSE);
        ...
        virtual MBOOL   IsReadOnlyMode(void) = 0;
//        virtual MBOOL   IsGdmaMode(void) = 0;
        //
        //commandQ
        ...
        virtual MUINT32 GlobalPipeCountInc(void) = 0;
        virtual MUINT32 GlobalPipeCountDec(void) = 0;

        // for turning update
        virtual MBOOL   updateTurningCq1(void);
        virtual MBOOL   updateTurningCq2(void);
        void    lockSemaphoreCq1();
        void    lockSemaphoreCq2();
        void    unlockSemaphoreCq1();
        void    unlockSemaphoreCq2();
        ...
        MBOOL setTurnTopEn1(int cq, int en1);
        MBOOL setTurnTopEn2(int cq, int en2);
        MBOOL setTurnTopDma(int cq, int dma);
        MBOOL flushTurnCqTable(int cq);
        MUINT32 getTurnTopEn1(int cq);
        MUINT32 getTurnTopEn2(int cq);
        MUINT32 getTurnTopDma(int cq);

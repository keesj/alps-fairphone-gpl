...
typedef struct {
    ...
    MUINT32 u4CropW;        //TG crop width
    MUINT32 u4CropH;        //TG crop height
    MUINT32 u4SubSpW;       // Subsampling width
    MUINT32 u4SubSpH;       // Subsampling height
    MUINT32 DataFmt;
} SENSOR_CROP_INFO;
...
typedef struct
{
  ...
  MUINT16 u2SensorSubSpW;
  MUINT16 u2SensorSubSpH;
...
typedef enum halSensorCmd_s {
    ...
    SENSOR_CMD_GET_SENSOR_SUBSAMPLING_INFO,

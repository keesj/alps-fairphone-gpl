...
MVOID AfMgr::setAFWinConfig(AF_AREA_T a_sAFArea)
{
    ...
    // 12 bits (4096x4096) - double buffer
    ISP_WRITE_BITS(m_pIspReg , CAM_AF_SIZE_E, AF_SIZE_XE, Boundary(FL_WIN_SIZE_MIN, i4W, FL_WIN_SIZE_MAX));
    ISP_WRITE_BITS(m_pIspReg , CAM_AF_SIZE_E, AF_SIZE_YE, Boundary(FL_WIN_SIZE_MIN, i4H, FL_WIN_SIZE_MAX));
    }
}

...
public:
    ...
    MRESULT enableAE();
    MRESULT disableAE();
    MRESULT doCapFlare(MVOID *pAEStatBuf,MVOID *pWBgResult,MBOOL bIsStrobe);
    ...
    MRESULT doPvAE(MVOID *pAEStatBuf,MVOID *pWBgResult);

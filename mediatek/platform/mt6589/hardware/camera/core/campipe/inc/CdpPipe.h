#ifndef _MTK_CAMERA_CORE_CAMPIPE_INC_CDP_PIPE_H_
#define _MTK_CAMERA_CORE_CAMPIPE_INC_CDP_PIPE_H_
//
#include <vector>
//
using namespace std;
...
private:
    NSImageio::NSIspio::ICdpPipe *mpCdpPipe;     
...
#endif  //  _MTK_CAMERA_CORE_CAMPIPE_INC_CDP_PIPE_H_

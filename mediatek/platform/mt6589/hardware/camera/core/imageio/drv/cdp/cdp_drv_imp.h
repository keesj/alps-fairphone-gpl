...
class CdpDrvImp : public CdpDrv
{
    ...
    //
    public:
        static CdpDrv*  GetInstance(bool fgIsGdmaMode = MFALSE);
...
//            MUINT32                 *pCoeffStep);
        ...
        virtual MBOOL   CalOffset(
            ...
            MUINT32*            pChromaInt,
            MUINT32*            pChromaSub);
        virtual MBOOL   AllocateRotationBuf(void);
        virtual MBOOL   FreeRotationBuf(void);
        ...
        virtual MBOOL   CURZ_ResetDefault(void);
        virtual MBOOL   CURZ_DumpReg(void);
        ...
        virtual MBOOL   CURZ_Config(
            ...
            CDP_DRV_IMG_SIZE_STRUCT     SizeOut,
            CDP_DRV_IMG_CROP_STRUCT     Crop);
        virtual MBOOL   CURZ_Unconfig(void);
        ...
        virtual MBOOL   PRZ_ResetDefault(void);
        virtual MBOOL   PRZ_DumpReg(void);
        ...
        virtual MBOOL   PRZ_Config(
            ...
            CDP_DRV_IMG_SIZE_STRUCT     SizeOut,
            CDP_DRV_IMG_CROP_STRUCT     Crop);
        virtual MBOOL   PRZ_Unconfig(void);
        ...
        virtual MBOOL   VIDO_ResetDefault(void);
        virtual MBOOL   VIDO_DumpReg(void);
        ...
        virtual MBOOL   VIDO_GetResetStatus(void);
        virtual MBOOL   VIDO_SetInterrupt(
            MBOOL       En,
            MBOOL       WriteClear);
        virtual MBOOL   VIDO_GetInterruptStatus(void);
        ...
        virtual MBOOL   VIDO_Unconfig(void);
        //DISPO
        virtual MBOOL   DISPO_Enable(MBOOL En);
        virtual MBOOL   DISPO_SetSource(CDP_DRV_DISPO_SRC_ENUM Source);
        virtual MBOOL   DISPO_ResetDefault(void);
        virtual MBOOL   DISPO_DumpReg(void);
        ...
        virtual MBOOL   DISPO_GetResetStatus(void);
        virtual MBOOL   DISPO_SetInterrupt(
            MBOOL       En,
            MBOOL       WriteClear);
        virtual MBOOL   DISPO_GetInterruptStatus(void);
        ...
        virtual MBOOL   DISPO_Config(
            ...
            MBOOL                       Flip,
            MBOOL                       fgDitherEnable);
        virtual MBOOL   DISPO_Unconfig(void);
    //
    private:
        mutable Mutex       mLock;

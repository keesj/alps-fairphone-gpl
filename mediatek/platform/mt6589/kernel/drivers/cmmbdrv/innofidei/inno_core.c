/************************************************
 * FileName:	inno_core.c
 *
 * Description:
 *		core driver for innofidei if101 v2 chip.
 * Author:		
 *		Jimmy.li <lizhengming@innofidei.com>
 * Created:
 * 		Dec.14, 2007
 * History:
 * 		Dec.25, 2007	-- 		add AP Interface Functions
 *		Jan.3, 2008		--		add inno_download_fireware function.
 *		Jan.7, 2008		--		add inno_set_cp_type function.
 *		Jan.11, 2008	--		implement inno_download_fireware function.
 * Copyright (c) 2007, Innofidei Inc
 *
 ***********************************************/

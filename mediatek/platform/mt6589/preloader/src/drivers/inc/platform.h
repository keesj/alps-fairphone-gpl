...
#define CFG_UBOOT_MEMADDR               (CFG_DRAM_ADDR + 0x01E00000)
...
/* Common buffer                                                         */	
/*=======================================================================*/
#define BOOT_ARGUMENT_ADDR              (CFG_DRAM_ADDR + 0x000A0000)
...
#else
#define STORAGE_BUFFER_ADDR             (CFG_DRAM_ADDR + 0x04000000)
#define COMMON_BUFFER_ADDR              (CFG_DRAM_ADDR + 0x04010000)
#define NAND_BUFFER_START               (CFG_DRAM_ADDR + 0x04020000)
#define SEC_REGION_ADDR                 (CFG_DRAM_ADDR + 0x04030000)
#define LOG_BUFFER_START                (CFG_DRAM_ADDR + 0x04830000)
#ifdef MTK_EMMC_SUPPORT
#define EMMC_PMT_BUFFER_START            (CFG_DRAM_ADDR + 0x4040000)

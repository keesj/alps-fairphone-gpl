...
S32 pwrap_init ( void )
{
  ...
  //enable clock,except kpd(bit[4] kpd and bit[6] 32k);
  //bit[6] 32k is used for kpd and pwm
...
void pwrap_dump_ap_register(void)
{
  ...
  //PWRAPREG("wacs3_write_cmd_done=%d,wacs3_read_cmd_start=%d,wacs3_read_cmd_done=%d,wacs3_vldclr_done=%d\n",wacs3_write_cmd_done,wacs3_read_cmd_start,wacs3_read_cmd_done,wacs3_vldclr_done);
  //PWRAPREG("wacs1_write_cmd_done=%d,wacs1_read_cmd_start=%d,wacs1_read_cmd_done=%d,wacs1_vldclr_done=%d\n",wacs1_write_cmd_done,wacs1_read_cmd_start,wacs1_read_cmd_done,wacs1_vldclr_done);
}

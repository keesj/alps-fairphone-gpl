...
#if defined(DEBUG_DRAMC_CALIB)
    print("==================================================================\n");
    print("         TX      DQS per byte calibration \n");
    print("==================================================================\n");
    print("\n--------------------------------------\n\n");
    /*
     * ==================================================================
         DQ              DQS
         15      0|0     15
Byte: 0, xxoooooooooooooo|oooooooooooooooo
Byte: 1, oooooooooooooooo|ooooooooooooxxxx
Byte: 2, xxoooooooooooooo|oooooooooooooooo
Byte: 3, oooooooooooooooo|oooooooooooxxxxx
     * */
    print("==================================================================\n");
    print("\tDQ\t\t\t\tDQS\n");
    print("\t15\t\t0|0\t\t15\n");
    for (byte = 0; byte < 4; byte++)
    {
        ...
        for (j = 15; j >= 0 ;j--)
        {
            if (j <= dqs_perbyte_dly[byte].last_dqdly_pass && j>= dqs_perbyte_dly[byte].first_dqdly_pass)
                print("o");
            else
                print("x");
        }
        ...
        for (j = 0; j <= 15 ;j++)
        {
            if (j <= dqs_perbyte_dly[byte].last_dqsdly_pass && j>= dqs_perbyte_dly[byte].first_dqsdly_pass)
                print("o");
            else
                print("x");
        }

...
#include <stk3171.h>  //add by lxingyong 
...
static struct alsps_hw_stk cust_alsps_hw = {  
    ...
    .als_level  = {5,  9, 36, 59, 82, 132, 205, 273, 500, 845, 1136, 1545, 2364, 4655, 6982 ,9225},	/* als_code */
    .als_value  = {0, 10, 40, 65, 90, 145, 225, 300, 550, 930, 1250, 1700, 2600, 5120, 7680, 10240},    /* lux */
   .als_cmd_val = 0x41,	/*ALS_GAIN=1, IT_ALS=200ms*/
   .ps_cmd_val = 0x21,	/*SLP=30ms, IT_PS=0.2ms*/
   .ps_gain_setting = 0x09, /*PS_GAIN=8X */
    .ps_threshold_high = 0x8,	//0x78,
    .ps_threshold_low = 0x5,	//0x6E,
};

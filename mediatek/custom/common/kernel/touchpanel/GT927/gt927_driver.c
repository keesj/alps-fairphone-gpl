...
static const struct i2c_device_id tpd_i2c_id[] = {{"gt927", 0}, {}};
static unsigned short force[] = {0, 0xBA, I2C_CLIENT_END, I2C_CLIENT_END};
static const unsigned short *const forces[] = { force, NULL };
//static struct i2c_client_address_data addr_data = { .forces = forces,};
static struct i2c_board_info __initdata i2c_tpd = { I2C_BOARD_INFO("gt927", (0xBA >> 1))};
...
static int gt927_config_write_proc(struct file *file, const char *buffer, unsigned long count, void *data)
{
    s32 ret = 0;
...
static s32 tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    */
    ...
    if (gt927_config_proc == NULL)
    {
        GTP_ERROR("create_proc_entry %s failed\n", GT927_CONFIG_PROC_FILE);
    }
    else
    {
...
{
    GTP_INFO("MediaTek gt927 touch panel driver init\n");
...
{
    GTP_INFO("MediaTek gt927 touch panel driver exit\n");

...
//    hwPowerOn(MT65XX_POWER_LDO_VGP, VOL_1800, "TP");
    ...
    hwPowerOn(MT65XX_POWER_LDO_VGP5, VOL_3300, "TP");
...
//		  printk("mhao 20121231 before input_x==%d  input_y==%d\n",input_x,input_y);
...
//		 input_x=1024-input_x;
		input_x = TPD_CALIBRATE_X(input_x);
		input_y = TPD_CALIBRATE_Y(input_y);
             #if 0
             	 input_y=TP_Y_MAX-input_y;
		 temp_xy=input_x;
		 input_x=input_y;
		 input_y=temp_xy;
		 #endif
//		   printk("mhao 20121231 after input_x==%d  input_y==%d\n",input_x,input_y);

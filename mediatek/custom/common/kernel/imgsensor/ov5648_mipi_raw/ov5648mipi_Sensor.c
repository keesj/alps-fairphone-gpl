...
void OV5648MIPI_Set_Mirror_Flip(kal_uint8 image_mirror)
{
	...
	{
		case IMAGE_NORMAL:
		    OV5648MIPI_write_cmos_sensor(0x3820,((OV5648MIPI_read_cmos_sensor(0x3820) & !0x06) | 0x00));
		    OV5648MIPI_write_cmos_sensor(0x3821,((OV5648MIPI_read_cmos_sensor(0x3821) & !0x06) | 0x06));
		    break;
		case IMAGE_H_MIRROR:
		    OV5648MIPI_write_cmos_sensor(0x3820,((OV5648MIPI_read_cmos_sensor(0x3820) & !0x06) | 0x00));
		    OV5648MIPI_write_cmos_sensor(0x3821,((OV5648MIPI_read_cmos_sensor(0x3821) & !0x06) | 0x00));
		    break;
		case IMAGE_V_MIRROR:
		    OV5648MIPI_write_cmos_sensor(0x3820,((OV5648MIPI_read_cmos_sensor(0x3820) & !0x06) | 0x06));
		    OV5648MIPI_write_cmos_sensor(0x3821,((OV5648MIPI_read_cmos_sensor(0x3821) & !0x06) | 0x06));		
		    break;
